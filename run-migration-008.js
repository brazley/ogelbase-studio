/**
 * Standalone Migration 008 Runner
 * Runs directly via Railway with DATABASE_URL
 */
...
(async () => {
  ...
  try {
    ...
    const migrationSQL = readFileSync(
      join(__dirname, 'apps/studio/database/migrations/008_add_active_org_tracking.sql'),
      'utf-8'
    );
